...
export class MatchCard extends Component {
    ...
    onConnected() {
        ...
        this.addEventListener(avatarPlayer, 'click', async (event) => {
            event.target.href = `/profile?id=${this.profileData.id}`;
            await Router.handleRouting(event);
        });

        this.addEventListener(avatarOpponent, 'click', async (event) => {
            event.target.href = `/profile?id=${this.opponentData.id}`;
            await Router.handleRouting(event);
        });
            ...
            <div class="match-card">
                <div class="player-card d-flex justify-content-center align-items-center
                    ...
                    <img src="${this.profileData.avatar}" alt="User Avatar"
                        id="avatar-player" class="player-avatar" data-link>
                    <span class="player-score">${this.myScore}</span>
                </div>
                ...
                <div class="player-card d-flex justify-content-center align-items-center
                    ...
                    <img id="avatar-opponent" src="${this.opponentData.avatar}"
                        alt="opponent Avatar" class="player-avatar" data-link>
                </div>
            </div>
        `;
    }
